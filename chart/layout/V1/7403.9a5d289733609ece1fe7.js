(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7403, 9937],
  {
    ...
    148982: (e, t, n) => {
      ...
      function c(e) {
        ...
        return r.createElement(i.Icon, {
          className: o()(l.icon, t && l.dropped),
          icon: a,
        });
      }
      function u(e) {
        ...
        return r.createElement(
          "span",
          { className: o()(l.button, n && l.disabled, t) },
          r.createElement(c, { isDropped: s })
        );
      }
      function d(e) {
        const {
        ...
        return r.createElement(
          "button",
          {
            ...
            tabIndex: n,
            disabled: s,
            className: o()(l.button, s && l.disabled, t),
          },
          r.createElement(c, { isDropped: i })
        );
      }
    },
    373989: (e, t, n) => {
    ...
    228837: (e, t, n) => {
      ...
      function u(e) {
        const {
          ...
          x = (0, i.renameColors)(e.color ?? "brand"),
          _ = (function (e) {
            let t = "";
            return (
              0 !== e &&
        ...
        return s(
          ...
          _,
          p && l().grouped,
          p && !f && l().adjustPosition,
          p && m.isTop && l().firstRow,
          p && m.isLeft && l().firstCol,
          g && b && l().multilineContent,
          v && l().link,
          c
        );
      }
    ...
    408323: (e, t, n) => {
      ...
      function c(e) {
        ...
        return r.createElement(
          ...
          r.createElement(i.CheckboxView, {
            className: l().view,
    ...
    611031: (e, t, n) => {
      ...
      function c(e) {
        ...
        return r.createElement(
          "span",
          { className: g, ...m },
          r.createElement(o.Icon, { icon: f, className: l().icon })
        );
      }
    },
    302946: (e, t, n) => {
      "use strict";
      n.d(t, { Checkbox: () => c, CheckboxView: () => u.CheckboxView });
      var r = n(50959),
        s = n(497754),
        o = n(230789),
        i = n(408323),
    ...
    34735: (e, t, n) => {
      ...
      function p(e, t, n, r) {
        const {
          ...
          x = h(o ?? (0, c.getGroupCellRemoveRoundBorders)(n));
        return s(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${a}`],
      ...
      function m(e, t, n) {
        ...
        const i = h(o ?? (0, c.getGroupCellRemoveRoundBorders)(t));
      ...
      function b(e, t) {
        ...
        return r.createElement(
          ...
          y,
          w,
          r.createElement("span", { className: m(e, E, D) })
        );
      }
      ...
      function i(e) {
        ...
        return (
          (0, s.useIsomorphicLayoutEffect)(() => {
            ...
            return (0, o.addOutsideEventListener)(d.current, r, l, document, e);
          }, [t, n, i, a, l]),
          c || u
        );
      }
    ...
    823030: (e, t, n) => {
      "use strict";
      n.d(t, { SubmenuContext: () => s, SubmenuHandler: () => o });
      var r = n(50959);
      ...
      function l(e) {
        ...
        if (e && 1 == ++i) {
          const e = (0, r.getCSSProperty)(t, "overflow"),
            s = (0, r.getCSSPropertyNumericValue)(t, "padding-right");
          "hidden" !== e.toLowerCase() &&
            t.scrollHeight > t.offsetHeight &&
            ((0, r.setStyle)(n, "right", `${(0, r.getScrollbarWidth)()}px`),
            (t.style.paddingRight = `${s + (0, r.getScrollbarWidth)()}px`),
            (a = !0)),
          ...
          (e = n
            ? ((l = (0, r.getContentWidth)(n)),
              s() ? 0 : o() ? 45 : Math.min(Math.max(l, 45), 450))
            : 0),
    ...
    510618: (e, t, n) => {
          ...
          super(e),
            ...
            (this._handleMeasure = ({
              ...
              const { position: n } = this.props,
                r = (0, i.ensureNotNull)(this._containerRef);
              ...
              const { width: h, height: p } = s,
                ...
                b = (0, a.clamp)(m.x, f, Math.max(f, g)),
                v = (m?.indentFromWindow?.top ?? 0) + c,
                x =
                  o -
                  (m.overrideHeight ?? p) -
                  (m?.indentFromWindow?.bottom ?? 0);
              let _ = (0, a.clamp)(m.y, v, Math.max(v, x));
              if (
              ...
              const C = m.overrideHeight ?? (d ? u : void 0);
              this.setState(
                {
              ...
              r.createElement(
                ...
                r.createElement(
                  "div",
                  {
                    ...
                    "aria-describedby": u,
                    "aria-invalid": d,
                    className: o()(v, b.menuWrap, !W && b.isMeasuring),
                    style: {
                      height: D,
                      left: N && N.x,
                      minWidth: g,
                  ...
                  r.createElement(
                    ...
                    r.createElement(x, { className: b.menuBox }, h)
                  )
                )
              ),
              r.createElement(c.Slot, { reference: this._handleSlot })
            )
          );
        }
        update(e) {
      ...
      function x(e) {
        const t = (0, i.ensureNotNull)((0, r.useContext)(p.SubmenuContext)),
          n = r.useRef(null);
        return r.createElement(
          "div",
          {
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((r = e.target), n.current?.contains(r))
                )
              )
                return;
              var r;
    ...
    28466: (e, t, n) => {
      ...
      var r = n(50959),
        s = n(370981);
      const o = r.createContext(s.globalCloseDelegate);
    },
    8361: (e, t, n) => {
      "use strict";
    ...
    467025: (e, t, n) => {
      "use strict";
      n.d(t, { DEFAULT_MAX: () => o, checkValueBoundaries: () => i });
      var r = n(609838),
        s = n(822960);
      const o = 9e15;
      function i(e) {
        ...
        return (
          c.passMax ||
            (u =
              l?.greaterThanMax ??
              r.t(null, { replace: { max: String(a) } }, n(631331))),
          c.passMin ||
            (u =
              l?.lessThanMin ??
              r.t(null, { replace: { min: String(i) } }, n(324216))),
