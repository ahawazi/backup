(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306, 3177],
  {
    ...
    373989: (t, e, o) => {
      ...
      o.d(e, { renameColors: () => i });
    },
    228837: (t, e, o) => {
      "use strict";
      o.d(e, { SquareButton: () => v });
      var i = o(50959),
        n = o(497754),
        r = o(331774),
        s = o(373989),
      ...
      function h(t) {
        const {
          ...
          y = (0, s.renameColors)(t.color ?? "brand"),
          b = (function (t) {
            let e = "";
            return (
              0 !== t &&
        ...
        return n(
          ...
          b,
          u && l().grouped,
          u && !g && l().adjustPosition,
          u && m.isTop && l().firstRow,
          u && m.isLeft && l().firstCol,
          _ && v && l().multilineContent,
          f && l().link,
          c
        );
      }
      function d(t) {
        ...
        if (e && s && o)
          return i.createElement(
            "span",
            { className: n(l().slot, l().startSlotWrap) },
            e
          );
        const d = o && (e ?? s),
          p = !e && !s && !o && !r && a && h;
        return i.createElement(
          ...
          r && !d && i.createElement("span", { className: l().content }, r),
          s &&
            i.createElement(
              "span",
              { className: n(l().slot, l().endSlotWrap) },
              s
            ),
          p &&
            !d &&
        ...
        const {
          ...
          b =
            ...
            (t.primaryText
              ...
              : (0, p.getTextForTooltip)(t.children));
        return i.createElement(
          "button",
          {
            ..._(c),
    ...
    496818: (t, e, o) => {
      "use strict";
      o.d(e, { Draggable: () => r, PointerBackend: () => s });
      var i = o(650151),
        n = o(821205);
      o(492575);
      class r {
        constructor(t) {
          (this._helper = null),
            (this._handleDragStart = (t) => {
              ...
              const [o, i] = [(0, n.outerWidth)(e), (0, n.outerHeight)(e)];
              (this._helper = {
    ...
    523847: (t, e, o) => {
      ...
      function v(t) {
        const {
          ...
          w = (0, m.useProperty)(e),
          T = (0, i.useRef)(null),
          C = w ? (0, l.parseRgba)(w)[3] : void 0,
          E = "" === w,
          x = String(L()).toLowerCase() === p.white,
          [S, P, D] = (0, h.useCustomColors)();
        return i.createElement(
          u.ToolWidgetMenu,
          {
            className: b,
            ...
            content: i.createElement(
              ...
              i.createElement(
                ...
                { className: _.colorBg },
                i.createElement("div", {
                  className: r()(_.color, E && _.multicolor, x && _.white),
                  style: E ? void 0 : { backgroundColor: w },
                })
              )
            ),
            arrow: !1,
          ...
          i.createElement(d.ColorPicker, {
            ...
            onColorChange: function (t, e) {
              ...
              B((0, c.generateColor)(String(t), o, true)),
                e || (0, s.ensureNotNull)(T.current).close();
            },
            ...
            onAddColor: function (t) {
              P(t), (0, s.ensureNotNull)(T.current).close();
            },
            onRemoveCustomColor: D,
          })
        );
        function L() {
    ...
    190266: (t, e, o) => {
      "use strict";
      o.d(e, { runOrSignIn: () => i, runOrSignInWithPromo: () => n });
      function i(t, e) {
        t();
      }
      function n(t, e, o) {
    ...
    44093: (t, e, o) => {
          ...
          T &&
            i.createElement(
              ...
              i.createElement(u.PopupMenuItem, {
                ...
                label: s.t(null, void 0, o(989984)),
                icon: _,
                onClick: function () {
                  C(), (0, h.ensureDefined)(l)();
                },
                dontClosePopup: !0,
              })
            )
          ...
          super(...arguments),
            ...
            (this._handleKeyDown = (t) => {
              const {
                ...
                r = (0, S.hashFromEvent)(t);
              if (!n || !L.includes(r)) return;
              if (37 === r || 39 === r) {
                return void n({
                  h: e,
                  s: (0, P.clamp)(37 === r ? o - B : o + B, 0, 1),
                  v: i,
                });
              }
              n({
            ...
            (this._mouseMove = (0, x.default)(this._handlePosition, 100)),
            (this._handleTouch = (t) => {
      ...
      var M = o(675187);
      const N = "#000000",
        R = s.t(null, { context: "Color Picker" }, o(155517));
      class I extends i.PureComponent {
        constructor(t) {
          ...
          const e = t.color || N;
          this.state = { color: e, inputColor: F(e), hsv: E(e) };
        }
        componentDidMount() {
      ...
      var O = o(160387);
      const V = s.t(null, { context: "Color Picker" }, o(329619)),
        z = s.t(null, { context: "Color Picker" }, o(980936));
      function H(t) {
        const {
            color: e,
            opacity: o,
            ...
            : i.createElement(
                ...
                s &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement("div", { className: O.sectionTitle }, z),
                    i.createElement(T.Opacity, {
                      color: e,
                      opacity: _,
                      onChange: function (t) {
                        d && d(t);
      ...
      function c(t, e) {
        return (o) => {
          ...
          const b = f === i.Top ? -1 * _ : _,
            ...
            T = f === i.Top ? p.top : p.bottom,
            C = {
              x: w - (m === s.FromRightToLeft ? c : 0) + g,
              y: T - (y === r.FromBottomToTop ? h : 0) + b,
            };
          return v && (C.overrideWidth = p.width), C;
        };
      }
    },
    155352: (t, e, o) => {
      ...
      const a = s,
        l = i.forwardRef((t, e) => {
          const {
            ...
            S = n(b, y.button, (f || E) && "apply-common-tooltip", {
              [y.isActive]: c,
              [y.isOpened]: h,
              [y.isInteractive]: (w || Boolean(g)) && !d && !T,
              [y.isDisabled]: Boolean(d || T),
              [y.isGrouped]: p,
              [y.hover]: u,
              [y.clicked]: m,
            }),
    ...
    679458: (t, e, o) => {
                ...
                o &&
                  i.createElement(
                    ...
                    i.createElement(
                      ...
                      i.createElement(l.ToolWidgetCaret, { dropped: y })
                    )
                  ),
                this.state.isOpened &&
                  (_
      ...
      y.defaultProps = { arrow: !0, closeOnClickOutside: !0, theme: _ };
    },
    27833: (t, e, o) => {
      "use strict";
      ...
      function S(t) {
        ...
        return i.createElement(
          y.ToolWidgetMenu,
          {
            className: C(n, x.dots),
            arrow: !1,
            title: e,
            drawerBreakpoint: w.TradingLayoutBreakpoint.Mobile,
            content: i.createElement(f.Icon, { icon: E }),
            "data-name": "more",
      ...
      class P extends s.FloatingToolbar {
        ...
        _onFavoriteAdded(t) {
          this.isVisible() && this._renderToolbarContent(),
            a.LinetoolsFavoritesStore.favorites().filter(D).length > 0 &&
        ...
        _onFavoriteRemoved(t) {
          delete this._linetoolsWidgets[t],
            this.isVisible() && this._renderToolbarContent(),
            0 === a.LinetoolsFavoritesStore.favorites().filter(D).length &&
        ...
        _createLinetoolWidget(t) {
          const e = `<span class="tv-favorited-drawings-toolbar__widget apply-common-tooltip ${
              ...
              p.lineToolsInfo[t].localizedName
            }" data-name="FavoriteToolbar${t}">${
              p.lineToolsInfo[t].icon
            }</span>`,
        ...
        _renderReactContent() {
          n.render(
            i.createElement(S, {
              title: r.t(null, void 0, o(437117)),
        ...
        _createHideToolbarAction() {
          return new c.Action({
            ...
            options: {
              label: r.t(null, void 0, o(322688)),
              onExecute: () => {
        ...
        _loadVisibilityState() {
          const t = a.LinetoolsFavoritesStore.favorites().filter(D).length > 0;
        ...
        constructor(t) {
          (this._items = []),
            ...
            (this._handleDragStart = (t) => {
              ...
              (this._helper = {
                ...
                leftBorder:
                  n.left +
                  v(o, "padding-left") +
                  v(o, "border-left-width") -
                  i.left -
                  1,
                rightBorder:
                  n.right -
                  v(o, "padding-right") -
                  v(o, "border-right-width") -
                  i.right +
                  1,
                topBorder:
                  n.top +
                  v(o, "padding-top") +
                  v(o, "border-top-width") -
                  i.top -
                  1,
                bottomBorder:
                  n.bottom -
                  v(o, "padding-bottom") -
                  v(o, "border-bottom-width") -
                  i.bottom +
                  1,
              }),
            ...
            (this._handleDragMove = (t) => {
              ...
              if ("y" === c) {
                const t = (0, u.clamp)(d, e, o);
                s.style.transform = `translateY(${t}px)`;
              }
              if ("x" === c) {
                const t = (0, u.clamp)(h, i, n);
      ...
      class T {
        constructor(t) {
          (this._widget = document.createElement("div")),
            ...
            (this._options = t),
            (this._widget = (0, f.parseHtmlElement)(w)),
    ...
    53266: (t, e, o) => {
      "use strict";
      o.d(e, { LineToolPropertiesWidgetBase: () => Jt });
      var i = o(50959),
        n = o(632227),
        r = o(609838),
        s = o(272047),
      ...
      var _ = o(543259),
        ...
        b = o(310107),
        w = o(996038);
      const T = b.FLOATING_TOOLBAR_REACT_WIDGETS_CLASS + "__button";
      function C(t) {
        const {
            templateButton: e,
            cancelButton: o,
      ...
      function M(t) {
        ...
        const a = s[0].properties().frozen,
          l = (0, D.useProperty)(a),
          c = l
            ? { tooltip: r.t(null, void 0, o(999894)), icon: A }
            : { tooltip: r.t(null, void 0, o(651077)), icon: k };
      ...
      function O(t) {
        const { activeChartWidget: e, className: n } = t,
          ...
          c = I(
            () =>
              new N.ActionsProvider(e).actionForLineTools(
                s,
        ...
        return c
          ? i.createElement(W, {
              className: n,
              isActive: Boolean(l),
              tooltip: r.t(null, void 0, o(174089)),
      ...
      function j(t) {
        ...
        const l = (0, D.useProperty)((0, h.alignTo45Degrees)()),
          c = l
            ? { tooltip: r.t(null, void 0, o(631145)), icon: U }
            : { tooltip: r.t(null, void 0, o(383187)), icon: U };
        return i.createElement(W, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
      ...
      async function it(t, e) {
        const i = [
            (0, N.createVisualOrderAction)(t, e),
            (0, N.createChangeIntervalsVisibilitiesAction)(t, e),
          ],
          n = (function (t, e) {
            const i = [],
              n = tt.isMacKeyboard ? " +" : "",
              ...
              i.push(
                new ot.Action({
                  ...
                  options: {
                    ...
                    label: r.t(null, void 0, o(712537)),
                    onExecute: () => {
            ...
            if (a.length > 0) {
              const e = {
                name: "copy",
                label: r.t(null, void 0, o(249680)),
                shortcutHint:
        ...
        if (
          ...
          const o = (0, N.createSyncDrawingActions)(t, e);
        ...
        return (
          i.push(
            new ot.Separator(),
            (0, N.createActionToggleVisibilityDataSources)(t, e)
          ),
          i
        );
      }
      ...
      function rt(t) {
        const {
          ...
          [l, c] = (0, i.useState)([]),
          h = (0, i.useRef)(null),
          d = (0, i.useMemo)(() => new N.ActionsProvider(o), [o]),
          p = (0, i.useCallback)(
            () =>
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(Q.ActionsTable, { parentIsOpened: !0, items: l })
          )
        );
      }
      function st(t) {
      ...
      function ut(t) {
          ...
          d = (0, i.useMemo)(
            () => [
              new ot.Action({
                ...
                options: {
                  icon: ct,
                  label: r.t(null, void 0, o(903554)),
              ...
              new ot.Action({
                ...
                options: {
                  icon: ht,
                  label: r.t(null, void 0, o(488123)),
        ...
        return i.createElement(
          ...
          i.createElement(Q.ActionsTable, { items: d })
        );
      }
      function mt(t) {
        switch (t) {
      ...
      function _t(t) {
        ...
        return i.createElement(
          ...
          i.createElement(Q.ActionsTable, { items: c })
        );
      }
      var vt = o(186661),
        ft = o(128492),
      ...
      function Ct(t) {
            ...
            return (
              l &&
                ...
                t.push(
                  new ot.Action({
                    ...
                    options: {
                      label: (0, bt.appendEllipsis)(
                        r.t(null, void 0, o(776047))
                      ),
                      onExecute: v,
                    },
                  })
              ...
              t.push(
                new ot.Action({
                  ...
                  options: {
                    label: r.t(null, void 0, o(114663)),
                    onExecute: n,
                  },
                })
              ),
              p
                ? t.push(new ot.Loader("Chart.LineTool.Templates.Apply"))
                : !p &&
                  m?.length &&
                  (t.push(new ot.Separator()),
                  t.push(
                    ...m.map(
                      (t) =>
                        new ot.Action({
        ...
        return i.createElement(
          Y.ToolWidgetMenu,
          {
            title: r.t(null, void 0, o(881152)),
            content: i.createElement(K.Icon, { icon: Tt }),
            onOpen: a.enabled("drawing_templates")
              ? function () {
                  u(!0),
            ...
            horizontalDropDirection: c
              ? lt.HorizontalDropDirection.FromLeftToRight
              : void 0,
            horizontalAttachEdge: c ? lt.HorizontalAttachEdge.Left : void 0,
            verticalAttachEdge: c ? lt.VerticalAttachEdge.Top : void 0,
            ref: _,
            ...d,
          },
          i.createElement(Q.ActionsTable, { items: f })
        );
      }
      var Et = o(792535),
        xt = o(185491),
        ...
        Wt = o(128245),
        At = o(787913);
      const kt = (0, Bt.mergeThemes)(Lt.DEFAULT_POPUP_MENU_ITEM_THEME, At),
        Mt = [8, 12, 20, 32, 48, 64, 80, 96];
      function Nt(t) {
        const {
            multipleProperty: e,
            title: o,
          ...
          c = (0, D.useProperty)((0, u.ensureDefined)(e));
        return i.createElement(
          Y.ToolWidgetMenu,
          {
            className: a,
            ...
            content: i.createElement(
              "div",
              { className: f()(At.buttonWrap, l && At.small) },
              i.createElement(K.Icon, { icon: Wt }),
              !l &&
                "mixed" !== c &&
                i.createElement("div", { className: At.buttonLabel }, `${c}px`)
            ),
          },
          Mt.map((t) =>
            i.createElement(Lt.PopupMenuItem, {
              key: t,
              theme: kt,
              label: `${t}px`,
              isActive: t === c,
      ...
      const It = !a.enabled("widget") || window.is_authenticated,
        Ft = new s.TranslatedString(
          "change line tool(s) font size",
          r.t(null, void 0, o(237453))
        ),
        Ot = new s.TranslatedString(
          "change line tool(s) line style",
          r.t(null, void 0, o(413423))
        ),
        Vt = new s.TranslatedString(
          "change line tool(s) line width",
          r.t(null, void 0, o(81303))
        ),
        zt = new s.TranslatedString(
          "line tool(s) line style",
          r.t(null, { context: "line tool property name" }, o(664974))
        ),
        Ht = r.t(null, void 0, o(232514)),
        Ut = r.t(null, void 0, o(199919)),
        Zt = r.t(null, void 0, o(767410)),
        jt = r.t(null, void 0, o(904543)),
        Gt = r.t(null, void 0, o(437117)),
        $t = r.t(null, void 0, o(492516)),
        Kt = r.t(null, void 0, o(702573)),
        qt = r.t(null, void 0, o(353002)),
        Xt = r.t(null, void 0, o(475056));
      function Yt(t) {
        return "LineToolBrush" === t || "LineToolHighlighter" === t;
      }
      const Qt = H.CheckMobile.any() || H.CheckMobile.isIPad();
      class Jt {
        constructor(t) {
        ...
        async _onToolChanged(t, e) {
          await (0, xt.ensureLineToolLoaded)(t), (this._currentTool = t);
          const o = this.selectedSources();
          if (this._isDrawingToolExcludingCustomUrlEventTool(t)) {
            if ((this._isDrawingFinished.setValue(!1), It)) {
              const o =
                e instanceof Et.DefaultProperty
                  ? e
                  : (0, ft.setNewToolProperties)(
                      t,
                      "LineToolIcon" === t
                        ? h.iconTool.value()
                        : "LineToolEmoji" === t
              ...
              this.showPropertiesOf(t, o, e instanceof Et.DefaultProperty),
                this._showTemplatesOf({ tool: t, properties: o }),
                (this._toolbarVisible = !0);
            }
            this._createCancelButton(), this._updateVisibility();
          } else
            o && o.length
        ...
        async _onSourceChanged(t) {
          ...
          if (
            (await Promise.all(
              t.map(async (t) => (0, xt.ensureLineToolLoaded)(t.toolname))
            ),
            ...
            this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
                  (!(0, St.isLineDrawnWithPressedButton)(e.toolname) &&
        ...
        _createSettingsButton() {
          const t = {
            component: P,
            props: { title: Ht, activeChartWidget: this.activeChartWidget() },
          };
        ...
        _createAlignTo45DegreesButton() {
          const t = {
            component: j,
            props: { title: Ut, activeChartWidget: this.activeChartWidget() },
            showForSmallScreen: !0,
          };
          this._addCommonButton(t);
        }
        _createRemoveButton() {
          if (Qt && null !== this._currentTool && Yt(this._currentTool)) return;
          const t = {
            component: z,
            props: { title: Zt, activeChartWidget: this.activeChartWidget() },
            showForSmallScreen: !0,
          };
          this._addCommonButton(t);
        }
        _createCancelButton() {
          if (
            ...
            !Qt || null === this._currentTool)
          )
            return;
          if (!Yt(this._currentTool)) return;
          const t = {
            component: $,
            props: { title: jt, activeChartWidget: this.activeChartWidget() },
            showForSmallScreen: !0,
          };
        ...
        _createFontSizeButton(t) {
          ...
          const o = e[0];
          if (!(0, Pt.isDataSource)(o)) return !1;
          const i = {
            component: _t,
            props: {
        ...
        _createHighlighterWidthsButton(t, e) {
          if (
            (this._highlighterWidthsProperty &&
              ...
              (this._highlighterWidthsProperty = null)),
            (this._highlighterWidthsProperty =
              this._createProperty(t, e, "widths", Vt) || null),
            !this._highlighterWidthsProperty)
          )
            return !0;
          const o =
        ...
        _updateVisibility() {
          (It || this._isDrawingFinished.value()) &&
          (this._toolbarVisible || this._propertiesVisible)
            ? this._show()
            : this.hide();
        }
        _showTemplatesOf(t) {
          if ((this._templatesButton && this._clearTemplatesButton(), !It))
            return;
          const e = "sources" in t;
          if (e && !t.sources.length) return;
          const o = e ? t.sources[0].toolname : t.tool;
          let i;
          if (
            ((this._templatesList = new yt.LinetoolTemplatesList(o, (i) => {
              this.activeChartWidget()
                .model()
                .applyLineToolsTemplate({ ...t, data: i }),
                e
                  ? this._onSourceChanged(t.sources)
                  : this._onToolChanged(o, t.properties);
            })),
            e && 1 === t.sources.length)
          ) {
            const {
              sources: [e],
            } = t;
          ...
          this._addTemplatesButton({
            ...
            props: {
              ...
              onSave: a.enabled("drawing_templates") ? i : void 0,
              onRestore: () => {
                e
                  ? this.activeChartWidget()
                      .model()
                      .restoreLineToolsFactoryDefaults(t.sources)
                  : t.properties.restoreFactoryDefaults(),
                  this.refresh();
              },
            },
          });
    ...
    816232: (t, e, o) => {
      ...
      var i = o(609838),
        ...
        l = o(153055),
        c = o(78943);
      const h = o(440891).enabled("drawing_templates");
      class d {
        constructor(t, e) {
          (this._toolName = t),
        ...
        loadTemplate(t, e) {
          n.store.dispatch(
            (0, r.loadTemplate)(this._toolName, t, async (t) => {
              this._applyTemplate(t), e?.();
            })
          );
        }
        removeTemplate(t) {
        ...
        deleteAction(t) {
          (0, a.runOrSignIn)(
            () => {
              const e = i.t(null, { replace: { name: t } }, o(57285));
              (0, l.showConfirm)({
                text: e,
                onConfirm: (e) => {
        ...
        showSaveDialog(t) {
          (0, a.runOrSignIn)(
            () => {
              (0, l.showRename)({
                title: i.t(null, void 0, o(776047)),
                text: i.t(null, void 0, o(59233)) + ":",
                maxLength: 64,
                source: this.getData() || [],
        ...
        async _loadData() {
          return new Promise((t) => {
            this.getData()
              ? t()
              : n.store.dispatch((0, r.getTemplates)(this._toolName, t));
          });
        }
      }
    },
    49337: (t, e, o) => {
      "use strict";
      var i = o(272047).TranslatedString,
        n = o(53266).LineToolPropertiesWidgetBase;
      ...
      var a = o(405880),
        ...
        h = new i(
          ...
          o.i18next(null, void 0, o(578655))
        ),
        d = new i(
          "change line tool(s) background color",
          o.i18next(null, void 0, o(150522))
        ),
        p = new i(
          "change line tool(s) text color",
          o.i18next(null, void 0, o(196142))
        ),
        u = new i(
          "change line tool(s) line width",
          o.i18next(null, void 0, o(81303))
        ),
        m = o.i18next(null, void 0, o(747370)),
        g = o.i18next(null, void 0, o(211989)),
        _ = o.i18next(null, void 0, o(77753)),
        v = o.i18next(null, void 0, o(681956)),
        f = o.i18next(null, void 0, o(369715)),
        y = o.i18next(null, void 0, o(614097)),
        b = o.i18next(null, void 0, o(492516)),
        w = o.i18next(null, void 0, o(992409)),
        T = o.i18next(null, void 0, o(353002)),
        C = o.i18next(null, void 0, o(475056)),
        E = o.i18next(null, void 0, o(128736)),
        x = o.i18next(null, void 0, o(265086)),
        S = o.i18next(null, void 0, o(346193)),
        P = o.i18next(null, void 0, o(307977)),
        D = o.i18next(null, void 0, o(908111));
      class L extends n {
        constructor(t) {
        ...
        _highlighterPropertiesExceptionCase() {
          return [
            this._defaultLinesColorProperty(),
            {
              name: "widths",
              inputType: "combobox",
              factory: L.prototype._createHighlighterWidthsButton,
            },
          ];
        }
        ...
        _createToolExceptionCases() {
          return {
            ...
            LineToolHighlighter:
              L.prototype._highlighterPropertiesExceptionCase(),
          };
        }
    ...
    403933: (t, e, o) => {
      "use strict";
      o.d(e, { TradingLayoutBreakpoint: () => n });
      var i = o(139535);
      const n = { Mobile: i.mobile };
    },
    279708: (t, e, o) => {
      "use strict";
      o.d(e, {
      ...
      var i = o(667259);
      function n(t, e) {
        return { type: i.GET_TEMPLATES, toolName: t, callback: e };
      }
      function r(t, e) {
    ...
    917568: (t, e, o) => {
      ...
      function* m() {
        for (;;) {
          ...
          try {
            yield (0, r.call)(d.backend.saveDrawingTemplate, t, e, o),
      ...
      function* g() {
        for (;;) {
          ...
          try {
            yield (0, r.call)(d.backend.removeDrawingTemplate, t, e),
        ...
        function* e(e) {
          try {
            const t = h(
              ...
              yield (0, r.call)(d.backend.getDrawingTemplates, e)
            );
            yield (0, r.put)((0, c.setTemplates)(e, t));
          } catch (t) {
            p.logWarn(t);
          }
          (0, s.ensureDefined)(t.get(e)).forEach((t) => t?.()), t.delete(e);
        }
      }
      function* v() {
        for (;;) {
          ...
          try {
            const i = h(
              ...
              yield (0, r.call)(d.backend.loadDrawingTemplate, t, e)
            );
            o && o(i);
          } catch (t) {
            p.logWarn(t);
      ...
      function w(t = y, e) {
        switch (e.type) {
          ...
          case a.SET_TEMPLATES: {
            ...
            return { ...t, templates: { ...t.templates, [o]: [...i].sort(b) } };
          }
      ...
      const T = (function () {
        const t = (0, n.default)(),
          e = (0, i.createStore)(w, (0, i.applyMiddleware)(t));
        return t.run(f), e;
      })();
    },
    543259: (t, e, o) => {
    ...
    78943: (t, e, o) => {
      ...
      function i(t, e) {
        return Boolean(
          "" === t || (t && -1 !== e.toLowerCase().indexOf(t.toLowerCase()))
        );
      }
