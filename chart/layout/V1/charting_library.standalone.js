var TradingView = (function (e) {
  ...
  let Ve = !1;
  function Fe() {
    return "TT v29.4.0 (internal id 29ac1aba6675f14818f3a5a9da75fa91c79107d0 @ 2025-06-25T14:10:09.016Z)";
  }
  const Ee = class {
    constructor(e) {
      if (
      ...
      "dark" === (this._options.theme ?? "light").toLowerCase() &&
        ...
        (this._options.debug || this._options.debug_broker) &&
          (Ve ||
            ((Ve = !0),
            console.log(
              "Using TT v29.4.0 (internal id 29ac1aba6675f14818f3a5a9da75fa91c79107d0 @ 2025-06-25T14:10:09.016Z)"
            ))),
    ...
    _render(e, t, i) {
      ...
      const r = (function (e, t) {
        const i = new URL(`${e || ""}`, location.href).href,
          o = JSON.parse(
            '["bundles/runtime.ea0bf94eec0f51895e4d.js","bundles/__LANG__.9762.7c9a1342de661f25c89b.js","bundles/4986.8b484bfeff805649f879.css","bundles/2614.3c6e9a4d2c016c8e0d98.js","bundles/library.529d5b8c7f545237e54b.js"]'
          ),
      ...
      const a =
        ...
        (this._options.time_scale
          ...
          : "");
      return [
        `<iframe\n\t\tversion="TT v29.4.0 (internal id 29ac1aba6675f14818f3a5a9da75fa91c79107d0 @ 2025-06-25T14:10:09.016Z)" id="${
          this._id
